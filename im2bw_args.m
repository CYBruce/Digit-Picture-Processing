...
% Last Modified by GUIDE v2.5 01-Jun-2018 09:45:36
...
h_figure1=findobj('Tag','figure_1');

setappdata(handles.figure_im2bw,'h_figure1',h_figure1);
axes(handles.axes1)
global img_src1
imshow(img_src1)
...
val = get(hObject,'Value');  %通过滑块获取阈值
set(handles.txt_display,'String',num2str(uint8(255*val)));
h_figure1=getappdata(handles.figure_im2bw,'h_figure1');
global m_handles
axes(handles.axes2)
global img_src1
global height0
global width0
global bw
bw = img_src1>=uint8(255*val)  %阈值化操作
imshow(bw);
